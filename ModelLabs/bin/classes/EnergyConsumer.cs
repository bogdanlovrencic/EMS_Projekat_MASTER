...
namespace FTN {
    ...
    public class EnergyConsumer : ConductingEquipment {
        ...
        private System.Single? cim_currentPower;
        
        private const bool isCurrentPowerMandatory = false;
        
        private const string _currentPowerPrefix = "cim";
        ...
        public virtual float CurrentPower {
            get {
                return this.cim_currentPower.GetValueOrDefault();
            }
            set {
                this.cim_currentPower = value;
            }
        }
        
        public virtual bool CurrentPowerHasValue {
            get {
                return this.cim_currentPower != null;
            }
        }
        
        public static bool IsCurrentPowerMandatory {
            get {
                return isCurrentPowerMandatory;
            }
        }
        
        public static string CurrentPowerPrefix {
            get {
                return _currentPowerPrefix;
            }
        }
