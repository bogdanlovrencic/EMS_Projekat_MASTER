...
namespace FTN.Services.NetworkModelService.DataModel.Wires
{
    public class PerLengthSequenceImpedance : PerLengthImpedance
    {
        ...
        public override bool HasProperty(ModelCode property)
        {
            switch (property)
            {
                case ModelCode.PLENSIM_B0CH:
                case ModelCode.PLENSIM_BCH:
                case ModelCode.PLENSIM_G0CH:
                case ModelCode.PLENSIM_GCH:
                case ModelCode.PLENSIM_X:
                case ModelCode.PLENSIM_X0:
                case ModelCode.PLENSIM_R:
                case ModelCode.PLENSIM_R0:
